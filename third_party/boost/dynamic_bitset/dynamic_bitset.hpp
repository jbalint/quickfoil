...
#ifndef QUICKFOIL_THIRD_PARTY_BOOST_DYNAMIC_BITSET_DYNAMIC_BITSET_HPP_
#define QUICKFOIL_THIRD_PARTY_BOOST_DYNAMIC_BITSET_DYNAMIC_BITSET_HPP_
...
private:
    ...
    friend class ::quickfoil::BitVectorBuilder;
    friend class ::quickfoil::BitVectorIterator;
...
dynamic_bitset<Block, Allocator>::find_next(size_type pos) const
{
    ...
    return fore?
        pos + static_cast<size_type>(::boost::lowest_bit(fore))
        :
...
#endif /* QUICKFOIL_THIRD_PARTY_BOOST_DYNAMIC_BITSET_DYNAMIC_BITSET_HPP_ */
